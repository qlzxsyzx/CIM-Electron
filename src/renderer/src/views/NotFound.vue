  ...
  <section class="w3l-errorhny-main">
    <div class="w3l-errorhnyhny-content">
      ...
      <div class="errorhnyhny-info">
        ...
        <router-link to="/chat/home" class="btn btn-style btn-outline-light mt-sm-5 mt-4">Back to Home</router-link>
      </div>
    </div>
  </section>
  <!--//Error-Page-->
...
.w3l-errorhny-main {
  ...
  align-items: center;
  height: 100vh;
  background: #3f81b3 url(../assets/img/404.jpg) no-repeat center;
